...
ColumnLayout {
    ...
    property real gap: Kwin.capsLock && Kwin.numLock ? parentSpacing : 0
    property real capsHeight: Kwin.capsLock ? capslockIcon.implicitHeight : 0
    property real numHeight: Kwin.numLock ? numlockIcon.implicitHeight : 0
